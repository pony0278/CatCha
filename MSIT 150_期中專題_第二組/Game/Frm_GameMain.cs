...
namespace FormResize
{
    ...
    public partial class Frm_GameMain : Form
    {
        ...
        {
            GamePurchasePage gamePurchasePage  = new GamePurchasePage();
        ...
        public void CCoinRefreshForShop(int i)
        {
            this.txt_CatCoin.Text = i.ToString();
            this.txt_RedStone.Text = i.ToString();
        }
