...
namespace CatCaha
{
    public partial class ZUserControl1 : UserControl
    {
        ...
        public ZUserControl1()
        {
            ...
            this.BackgroundImage = CatCaha.Properties.Resources.Gameshop_Product_back1;
            user = user;
            product = product;
            coin = new ChargeCoin();
        ...
        private void Button_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                if (result == "成功")
                {
                    ...
                    Frm_GameMain main = Application.OpenForms.OfType<Frm_GameMain>().FirstOrDefault();
                    if (main != null)
                    {
                        main.CCoinRefreshForShop((int)qCoinRefresh.FirstOrDefault());
                    }
                }
                else if(result == "額度不足")
                {
