    ...
    public class mixRandomDrow
    {
        ...
        public void Drow()
        {
            ...
            while (!hasWonPrize)
            {
                ...
                {
                    "../../CatPicture/P_coupon.png",        // 實體折價券（2%）
                    "../../CatPicture/cat_w_sR.gif",        // 貓咪（5%）
                    "../../CatPicture/P_background.png",    // 背景（5%）
                    "../../CatPicture/P_bowl.png",          // 飯盆（13%）
                    "../../CatPicture/P_lamp.png",          // 家具（5%）
                    "../../CatPicture/P_food.png",          // 飼料（25%）
                    "../../CatPicture/P_water.png",         // 水（25%）
                    "../../CatPicture/P_coin.png"           // 貓幣（20%）
                };
