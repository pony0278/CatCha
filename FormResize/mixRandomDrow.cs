    ...
    public class mixRandomDrow
    {
        ...
        public void Drow()
        {
            ...
            while (!hasWonPrize)
            {
                ...
                {
                    "..//..//Resources\\P_coupon.png",        // 實體折價券（2%）
                    "..//..//Resources\\cat_w_sR.gif",        // 貓咪（5%）
                    "..//..//Resources\\P_background.png",    // 背景（5%）
                    "..//..//Resources\\P_bowl.png",          // 飯盆（13%）
                    "..//..//Resources\\P_lamp.png",          // 家具（5%）
                    "..//..//Resources\\P_food.png",          // 飼料（25%）
                    "..//..//Resources\\P_water.png",         // 水（25%）
                    "..//..//Resources\\_catcoin.png"           // 貓幣（20%）
                };
