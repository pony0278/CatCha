...
namespace 抽卡
{
    ...
    public partial class Frm_Summon : Form
    {
        ...
        public Frm_Summon(Frm_GameMain ParentForm)
        {
            ...
            this.pictureBox1.Image = new Bitmap("..//..//Resources\\cat_g_sR.gif");
        ...
        {
            pictureBox2.Image = new Bitmap("..//..//Resources\\gacha_Animate_A_v2.gif");
            StartAnimation();
        ...
        {
            StartAnimation();
            pictureBox2.Image = new Bitmap("..//..//Resources\\gacha_Animate_S_v2.gif");
            await Task.Delay(2000);
        ...
        {
            StartAnimation();
            pictureBox2.Image = new Bitmap("..//..//Resources\\gacha_Animate_SS_v2.gif");
            await Task.Delay(2000);
